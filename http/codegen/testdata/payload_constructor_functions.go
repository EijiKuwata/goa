...
var PayloadQueryMapStringStringConstructorCode = `// NewMethodQueryMapStringStringMethodQueryMapStringStringPayload builds a
// ServiceQueryMapStringString service MethodQueryMapStringString endpoint
// payload.
func NewMethodQueryMapStringStringMethodQueryMapStringStringPayload(q map[string]string) *servicequerymapstringstring.MethodQueryMapStringStringPayload {
...
var PayloadQueryMapStringStringValidateConstructorCode = `// NewMethodQueryMapStringStringValidateMethodQueryMapStringStringValidatePayload
// builds a ServiceQueryMapStringStringValidate service
// MethodQueryMapStringStringValidate endpoint payload.
func NewMethodQueryMapStringStringValidateMethodQueryMapStringStringValidatePayload(q map[string]string) *servicequerymapstringstringvalidate.MethodQueryMapStringStringValidatePayload {
...
var PayloadQueryMapStringBoolConstructorCode = `// NewMethodQueryMapStringBoolMethodQueryMapStringBoolPayload builds a
// ServiceQueryMapStringBool service MethodQueryMapStringBool endpoint payload.
func NewMethodQueryMapStringBoolMethodQueryMapStringBoolPayload(q map[string]bool) *servicequerymapstringbool.MethodQueryMapStringBoolPayload {
...
var PayloadQueryMapStringBoolValidateConstructorCode = `// NewMethodQueryMapStringBoolValidateMethodQueryMapStringBoolValidatePayload
// builds a ServiceQueryMapStringBoolValidate service
// MethodQueryMapStringBoolValidate endpoint payload.
func NewMethodQueryMapStringBoolValidateMethodQueryMapStringBoolValidatePayload(q map[string]bool) *servicequerymapstringboolvalidate.MethodQueryMapStringBoolValidatePayload {
...
var PayloadQueryMapBoolStringConstructorCode = `// NewMethodQueryMapBoolStringMethodQueryMapBoolStringPayload builds a
// ServiceQueryMapBoolString service MethodQueryMapBoolString endpoint payload.
func NewMethodQueryMapBoolStringMethodQueryMapBoolStringPayload(q map[bool]string) *servicequerymapboolstring.MethodQueryMapBoolStringPayload {
...
var PayloadQueryMapBoolStringValidateConstructorCode = `// NewMethodQueryMapBoolStringValidateMethodQueryMapBoolStringValidatePayload
// builds a ServiceQueryMapBoolStringValidate service
// MethodQueryMapBoolStringValidate endpoint payload.
func NewMethodQueryMapBoolStringValidateMethodQueryMapBoolStringValidatePayload(q map[bool]string) *servicequerymapboolstringvalidate.MethodQueryMapBoolStringValidatePayload {
...
var PayloadQueryMapBoolBoolConstructorCode = `// NewMethodQueryMapBoolBoolMethodQueryMapBoolBoolPayload builds a
// ServiceQueryMapBoolBool service MethodQueryMapBoolBool endpoint payload.
func NewMethodQueryMapBoolBoolMethodQueryMapBoolBoolPayload(q map[bool]bool) *servicequerymapboolbool.MethodQueryMapBoolBoolPayload {
...
var PayloadQueryMapBoolBoolValidateConstructorCode = `// NewMethodQueryMapBoolBoolValidateMethodQueryMapBoolBoolValidatePayload
// builds a ServiceQueryMapBoolBoolValidate service
// MethodQueryMapBoolBoolValidate endpoint payload.
func NewMethodQueryMapBoolBoolValidateMethodQueryMapBoolBoolValidatePayload(q map[bool]bool) *servicequerymapboolboolvalidate.MethodQueryMapBoolBoolValidatePayload {
...
var PayloadQueryMapStringArrayStringConstructorCode = `// NewMethodQueryMapStringArrayStringMethodQueryMapStringArrayStringPayload
// builds a ServiceQueryMapStringArrayString service
// MethodQueryMapStringArrayString endpoint payload.
func NewMethodQueryMapStringArrayStringMethodQueryMapStringArrayStringPayload(q map[string][]string) *servicequerymapstringarraystring.MethodQueryMapStringArrayStringPayload {
...
var PayloadQueryMapStringArrayStringValidateConstructorCode = `// NewMethodQueryMapStringArrayStringValidateMethodQueryMapStringArrayStringValidatePayload
// builds a ServiceQueryMapStringArrayStringValidate service
// MethodQueryMapStringArrayStringValidate endpoint payload.
func NewMethodQueryMapStringArrayStringValidateMethodQueryMapStringArrayStringValidatePayload(q map[string][]string) *servicequerymapstringarraystringvalidate.MethodQueryMapStringArrayStringValidatePayload {
...
var PayloadQueryMapStringArrayBoolConstructorCode = `// NewMethodQueryMapStringArrayBoolMethodQueryMapStringArrayBoolPayload builds
// a ServiceQueryMapStringArrayBool service MethodQueryMapStringArrayBool
// endpoint payload.
func NewMethodQueryMapStringArrayBoolMethodQueryMapStringArrayBoolPayload(q map[string][]bool) *servicequerymapstringarraybool.MethodQueryMapStringArrayBoolPayload {
...
var PayloadQueryMapStringArrayBoolValidateConstructorCode = `// NewMethodQueryMapStringArrayBoolValidateMethodQueryMapStringArrayBoolValidatePayload
// builds a ServiceQueryMapStringArrayBoolValidate service
// MethodQueryMapStringArrayBoolValidate endpoint payload.
func NewMethodQueryMapStringArrayBoolValidateMethodQueryMapStringArrayBoolValidatePayload(q map[string][]bool) *servicequerymapstringarrayboolvalidate.MethodQueryMapStringArrayBoolValidatePayload {
...
var PayloadQueryMapBoolArrayStringConstructorCode = `// NewMethodQueryMapBoolArrayStringMethodQueryMapBoolArrayStringPayload builds
// a ServiceQueryMapBoolArrayString service MethodQueryMapBoolArrayString
// endpoint payload.
func NewMethodQueryMapBoolArrayStringMethodQueryMapBoolArrayStringPayload(q map[bool][]string) *servicequerymapboolarraystring.MethodQueryMapBoolArrayStringPayload {
...
var PayloadQueryMapBoolArrayStringValidateConstructorCode = `// NewMethodQueryMapBoolArrayStringValidateMethodQueryMapBoolArrayStringValidatePayload
// builds a ServiceQueryMapBoolArrayStringValidate service
// MethodQueryMapBoolArrayStringValidate endpoint payload.
func NewMethodQueryMapBoolArrayStringValidateMethodQueryMapBoolArrayStringValidatePayload(q map[bool][]string) *servicequerymapboolarraystringvalidate.MethodQueryMapBoolArrayStringValidatePayload {
...
var PayloadQueryMapBoolArrayBoolConstructorCode = `// NewMethodQueryMapBoolArrayBoolMethodQueryMapBoolArrayBoolPayload builds a
// ServiceQueryMapBoolArrayBool service MethodQueryMapBoolArrayBool endpoint
// payload.
func NewMethodQueryMapBoolArrayBoolMethodQueryMapBoolArrayBoolPayload(q map[bool][]bool) *servicequerymapboolarraybool.MethodQueryMapBoolArrayBoolPayload {
...
var PayloadQueryMapBoolArrayBoolValidateConstructorCode = `// NewMethodQueryMapBoolArrayBoolValidateMethodQueryMapBoolArrayBoolValidatePayload
// builds a ServiceQueryMapBoolArrayBoolValidate service
// MethodQueryMapBoolArrayBoolValidate endpoint payload.
func NewMethodQueryMapBoolArrayBoolValidateMethodQueryMapBoolArrayBoolValidatePayload(q map[bool][]bool) *servicequerymapboolarrayboolvalidate.MethodQueryMapBoolArrayBoolValidatePayload {
